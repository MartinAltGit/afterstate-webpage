...
export type CollectionDetailFragment = Pick<
  StorefrontAPI.Collection,
...
export type ProductMetafieldsFragment = {
  subtitle?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  collectionNumber?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  fit?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value' | 'type'>>;
  fitNotes?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  fabric?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value' | 'type'>>;
  fabricComposition?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  fabricWeightGsm?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  construction?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  measurements?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  modelInformation?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  designStory?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  ...
  sizeGuide?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  shippingNote?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  productBadge?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  editorialMedia?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'> & {
  ...
  >;
  completeTheLook?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'> & {
      references?: StorefrontAPI.Maybe<{
        nodes: Array<
          Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
  ...
  >;
  seoTitleOverride?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  seoDescriptionOverride?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
};
  ...
  media: {
    nodes: Array<
      | ({__typename: 'ExternalVideo'} & Pick<
          ...
          'id' | 'embedUrl' | 'originUrl' | 'mediaContentType' | 'alt'
        > & {
...
export type CampaignsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type CampaignsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle' | 'type' | 'updatedAt'> & {
        fields: Array<
          Pick<StorefrontAPI.MetaobjectField, 'key' | 'type' | 'value'> & {
            reference?: StorefrontAPI.Maybe<
              | (Pick<StorefrontAPI.Collection, 'id' | 'handle' | 'title'> & {
...
export type CampaignByHandleQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CampaignByHandleQuery = {
...
export type LookbooksQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LookbooksQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle' | 'type' | 'updatedAt'> & {
        fields: Array<
...
export type LookbookByHandleQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LookbookByHandleQuery = {
  metaobject?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metaobject, 'id' | 'handle' | 'type' | 'updatedAt'> & {
      fields: Array<
        Pick<StorefrontAPI.MetaobjectField, 'key' | 'type' | 'value'> & {
...
export type CollectionChaptersQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionChaptersQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle' | 'type' | 'updatedAt'> & {
        fields: Array<
...
export type JournalArticleCardFragment = Pick<
  StorefrontAPI.Article,
  'id' | 'handle' | 'title' | 'excerpt' | 'publishedAt'
> & {
  image?: StorefrontAPI.Maybe<
...
export type JournalIndexQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
  last?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CampaignByHandle(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    metaobject(handle: {type: "campaign", handle: $handle}) {\n      ...MetaobjectFields\n    }\n  }\n  #graphql\n  fragment MetaobjectFields on Metaobject {\n    id\n    handle\n    type\n    updatedAt\n    fields {\n      key\n      type\n      value\n      reference {\n        ... on MediaImage {\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Video {\n          id\n          sources {\n            url\n            mimeType\n          }\n          previewImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Product {\n          id\n          handle\n          title\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Collection {\n          id\n          handle\n          title\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Metaobject {\n          id\n          handle\n          type\n          fields {\n            key\n            type\n            value\n          }\n        }\n      }\n      references(first: 24) {\n        nodes {\n          ... on MediaImage {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n          ... on Product {\n            id\n            handle\n            title\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            priceRange {\n              minVariantPrice {\n                amount\n                currencyCode\n              }\n            }\n          }\n          ... on Collection {\n            id\n            handle\n            title\n          }\n          ... on Metaobject {\n            id\n            handle\n            type\n            fields {\n              key\n              type\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n\n': {
    return: CampaignByHandleQuery;
    variables: CampaignByHandleQueryVariables;
  };
  '#graphql\n  query Lookbooks(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    metaobjects(type: "lookbook", first: 20) {\n      nodes {\n        ...MetaobjectFields\n      }\n    }\n  }\n  #graphql\n  fragment MetaobjectFields on Metaobject {\n    id\n    handle\n    type\n    updatedAt\n    fields {\n      key\n      type\n      value\n      reference {\n        ... on MediaImage {\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Video {\n          id\n          sources {\n            url\n            mimeType\n          }\n          previewImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Product {\n          id\n          handle\n          title\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Collection {\n          id\n          handle\n          title\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Metaobject {\n          id\n          handle\n          type\n          fields {\n            key\n            type\n            value\n          }\n        }\n      }\n      references(first: 24) {\n        nodes {\n          ... on MediaImage {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n          ... on Product {\n            id\n            handle\n            title\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            priceRange {\n              minVariantPrice {\n                amount\n                currencyCode\n              }\n            }\n          }\n          ... on Collection {\n            id\n            handle\n            title\n          }\n          ... on Metaobject {\n            id\n            handle\n            type\n            fields {\n              key\n              type\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n\n': {
    return: LookbooksQuery;
    variables: LookbooksQueryVariables;
  };
  '#graphql\n  query LookbookByHandle(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    metaobject(handle: {type: "lookbook", handle: $handle}) {\n      ...MetaobjectFields\n    }\n  }\n  #graphql\n  fragment MetaobjectFields on Metaobject {\n    id\n    handle\n    type\n    updatedAt\n    fields {\n      key\n      type\n      value\n      reference {\n        ... on MediaImage {\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Video {\n          id\n          sources {\n            url\n            mimeType\n          }\n          previewImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Product {\n          id\n          handle\n          title\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Collection {\n          id\n          handle\n          title\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Metaobject {\n          id\n          handle\n          type\n          fields {\n            key\n            type\n            value\n          }\n        }\n      }\n      references(first: 24) {\n        nodes {\n          ... on MediaImage {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n          ... on Product {\n            id\n            handle\n            title\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            priceRange {\n              minVariantPrice {\n                amount\n                currencyCode\n              }\n            }\n          }\n          ... on Collection {\n            id\n            handle\n            title\n          }\n          ... on Metaobject {\n            id\n            handle\n            type\n            fields {\n              key\n              type\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n\n': {
    return: LookbookByHandleQuery;
    variables: LookbookByHandleQueryVariables;
  };
  '#graphql\n  query CollectionChapters(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    metaobjects(type: "collection_chapter", first: 20) {\n      nodes {\n        ...MetaobjectFields\n      }\n    }\n  }\n  #graphql\n  fragment MetaobjectFields on Metaobject {\n    id\n    handle\n    type\n    updatedAt\n    fields {\n      key\n      type\n      value\n      reference {\n        ... on MediaImage {\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Video {\n          id\n          sources {\n            url\n            mimeType\n          }\n          previewImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Product {\n          id\n          handle\n          title\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Collection {\n          id\n          handle\n          title\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        ... on Metaobject {\n          id\n          handle\n          type\n          fields {\n            key\n            type\n            value\n          }\n        }\n      }\n      references(first: 24) {\n        nodes {\n          ... on MediaImage {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n          ... on Product {\n            id\n            handle\n            title\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            priceRange {\n              minVariantPrice {\n                amount\n                currencyCode\n              }\n            }\n          }\n          ... on Collection {\n            id\n            handle\n            title\n          }\n          ... on Metaobject {\n            id\n            handle\n            type\n            fields {\n              key\n              type\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n\n': {
    return: CollectionChaptersQuery;
    variables: CollectionChaptersQueryVariables;
  };
  ...
  '#graphql\n  query JournalIndex(\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n    $last: Int\n    $startCursor: String\n    $endCursor: String\n  ) @inContext(country: $country, language: $language) {\n    blog(handle: "journal") {\n      id\n      handle\n      title\n      seo {\n        title\n        description\n      }\n      articles(\n        first: $first\n        last: $last\n        before: $startCursor\n        after: $endCursor\n        sortKey: PUBLISHED_AT\n        reverse: true\n      ) {\n        nodes {\n          ...JournalArticleCard\n        }\n        pageInfo {\n          hasNextPage\n          hasPreviousPage\n          startCursor\n          endCursor\n        }\n      }\n    }\n  }\n  #graphql\n  fragment JournalArticleCard on Article {\n    id\n    handle\n    title\n    excerpt\n    publishedAt\n    image {\n      id\n      altText\n      url\n      width\n      height\n    }\n    author: authorV2 {\n      name\n    }\n  }\n\n': {
    return: JournalIndexQuery;
    variables: JournalIndexQueryVariables;
  };
